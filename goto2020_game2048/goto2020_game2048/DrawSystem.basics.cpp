...
void DrawSystem::text(std::string str, double x, double y, int size, Color color) {
	sf::Text drawnText;
	drawnText.setFont(font);
	drawnText.setString(str);
...
void DrawSystem::fillCircle(Vec2 pos, Vec2 box, double r, Color color) {
